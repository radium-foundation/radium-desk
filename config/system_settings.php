...
return [
    'categories' => [
        ...
        'hybrid_realtime' => [
            'label' => 'Hybrid Realtime',
            'description' => 'Opt-in Reverb features for dashboard row updates. Polling remains the safety net when disabled.',
            'icon' => 'bi-broadcast',
            'sort' => 80,
        ],
    ],
    ...
    'settings' => [
        ...
        'hybrid_realtime.incoming_calls' => [
            ...
            'description' => 'Coming Soon — not wired yet.',
            'type' => 'boolean',
            'default' => false,
            'disabled' => true,
        ],
