...
class RolePermissionSeeder extends Seeder
{
    ...
    public const PERMISSION_FINANCE_PARTIES_VIEW = 'finance.parties.view';

    public const PERMISSION_FINANCE_PARTIES_MANAGE = 'finance.parties.manage';

    public const PERMISSION_FINANCE_PARTIES_BANK_VIEW = 'finance.parties.bank.view';
    ...
    private const FINANCE_MODULE_VIEW_PERMISSIONS = [
        ...
        self::PERMISSION_FINANCE_PARTIES_VIEW,
    ];
    ...
    private const ROLE_PERMISSIONS = [
        ...
        self::ROLE_ADMIN => [
            ...
            self::PERMISSION_FINANCE_PARTIES_MANAGE,
            self::PERMISSION_FINANCE_PARTIES_BANK_VIEW,
            self::PERMISSION_CASHBOOK_VIEW,
            self::PERMISSION_CASHBOOK_CREATE,
            self::PERMISSION_CASHBOOK_MANAGE,
            self::PERMISSION_EMAIL_REPLY,
