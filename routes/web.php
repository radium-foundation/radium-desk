...
use App\Http\Controllers\Pos\CustomerLookupController as PosCustomerLookupController;
...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::prefix('purchasing')->name('purchasing.')->group(function () {
        ...
        Route::get('vendors/search', [PurchasingVendorController::class, 'search'])->name('vendors.search');
    ...
    Route::prefix('services')->name('services.')->group(function () {
        Route::redirect('/', '/services/items');
        Route::get('categories', [ServiceCategoryController::class, 'index'])->name('categories.index');
        Route::get('items', [ServiceItemController::class, 'index'])->name('items.index');
        Route::get('items/create', [ServiceItemController::class, 'create'])->name('items.create');
        Route::post('items', [ServiceItemController::class, 'store'])->name('items.store');
        Route::get('items/{item}/edit', [ServiceItemController::class, 'edit'])->name('items.edit');
        Route::put('items/{item}', [ServiceItemController::class, 'update'])->name('items.update');
        Route::patch('items/{item}/toggle', [ServiceItemController::class, 'toggle'])->name('items.toggle');
    });
    ...
    Route::prefix('service-pos')->name('service-pos.')->group(function () {
        ...
        Route::get('quotes/{quote}', [ServicePosQuoteController::class, 'show'])->name('quotes.show');
        Route::get('quotes/{quote}/print', [ServicePosQuoteController::class, 'print'])->name('quotes.print');
        Route::post('quotes/{quote}/convert', [ServicePosQuoteController::class, 'convert'])->name('quotes.convert');
        Route::get('orders/{serviceOrder}', [ServicePosOrderController::class, 'show'])->name('orders.show');
        Route::post('orders/{serviceOrder}/issue-invoice', [ServicePosOrderController::class, 'issueInvoice'])->name('orders.issue-invoice');
    });
    ...
    Route::prefix('pos')->name('pos.')->group(function () {
        ...
        Route::get('customers/search', [PosCustomerLookupController::class, 'search'])->name('customers.search');
        Route::get('customers/lookup', [PosCustomerLookupController::class, 'lookup'])->name('customers.lookup');
        Route::get('customers/{customer}', [PosCustomerLookupController::class, 'show'])->name('customers.show');
