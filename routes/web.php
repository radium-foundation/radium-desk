...
use App\Http\Controllers\Finance\PartyController as FinancePartyController;
...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::post('dashboard/service-cases/{incident}/email-thread/read', [Customer360Controller::class, 'markEmailThreadRead'])
        ->name('dashboard.service-cases.email-thread.read');
    ...
    Route::prefix('finance')->name('finance.')->group(function () {
        ...
        Route::get('parties', [FinancePartyController::class, 'index'])->name('parties.index');
        Route::get('parties/create', [FinancePartyController::class, 'create'])->name('parties.create');
        Route::post('parties', [FinancePartyController::class, 'store'])->name('parties.store');
        Route::get('parties/{party}', [FinancePartyController::class, 'show'])->name('parties.show');
        Route::put('parties/{party}', [FinancePartyController::class, 'update'])->name('parties.update');
        Route::patch('parties/{party}/deactivate', [FinancePartyController::class, 'deactivate'])->name('parties.deactivate');
        Route::patch('parties/{party}/activate', [FinancePartyController::class, 'activate'])->name('parties.activate');
        Route::post('parties/{party}/addresses', [FinancePartyController::class, 'storeAddress'])->name('parties.addresses.store');
        Route::put('parties/{party}/addresses/{address}', [FinancePartyController::class, 'updateAddress'])->name('parties.addresses.update');
        Route::post('parties/{party}/contacts', [FinancePartyController::class, 'storeContact'])->name('parties.contacts.store');
        Route::put('parties/{party}/contacts/{contact}', [FinancePartyController::class, 'updateContact'])->name('parties.contacts.update');
        Route::post('parties/{party}/gst', [FinancePartyController::class, 'storeGst'])->name('parties.gst.store');
        Route::put('parties/{party}/gst/{gst}', [FinancePartyController::class, 'updateGst'])->name('parties.gst.update');
        Route::put('parties/{party}/customer-terms', [FinancePartyController::class, 'updateCustomerTerms'])->name('parties.customer-terms.update');
        Route::put('parties/{party}/vendor-terms', [FinancePartyController::class, 'updateVendorTerms'])->name('parties.vendor-terms.update');
        Route::post('parties/{party}/vendor-banks', [FinancePartyController::class, 'storeVendorBank'])->name('parties.vendor-banks.store');
    ...
    Route::prefix('inventory')->name('inventory.')->group(function () {
        ...
        Route::post('hardware-fulfilments/{fulfilment}/ready', [InventoryHardwareFulfilmentSerialController::class, 'storeReady'])->name('hardware-fulfilments.ready.store');
