...
class LeastWorkloadSupportAssignmentStrategy implements SupportAssignmentStrategy
{
    public function type(): string
    {
        return SupportAssignmentStrategyType::LeastWorkload->value;
    }
    ...
    {
        throw new LogicException('Least workload support assignment is not enabled in production.');
    }
}
