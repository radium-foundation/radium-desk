...
class PerformanceBasedSupportAssignmentStrategy implements SupportAssignmentStrategy
{
    public function type(): string
    {
        return SupportAssignmentStrategyType::Performance->value;
    }
    ...
    {
        throw new LogicException('Performance-based support assignment is not enabled in production.');
    }
}
