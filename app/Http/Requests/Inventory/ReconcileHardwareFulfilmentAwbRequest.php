...
class ReconcileHardwareFulfilmentAwbRequest extends FormRequest
{
    ...
    {
        return [
            'awb.prohibited' => 'AWB is reconciled from Shiprocket and cannot be entered.',
            'courier_id.prohibited' => 'Courier is reconciled from Shiprocket and cannot be entered.',
        ];
    }
}
