    ...
    public function run(?string $table = null, ?int $tier = null): SyncVerificationReport
    {
        ...
        foreach ($tables as $definition) {
            ...
            $tableRows[] = [
                ...
                'unique_indexes' => $definition->businessUniqueKeys,
                'business_unique_keys' => $definition->businessUniqueKeys,
                'physical_unique_indexes' => $definition->physicalUniqueIndexes,
