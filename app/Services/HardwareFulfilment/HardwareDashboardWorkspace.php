...
final class HardwareDashboardWorkspace
{
    ...
    private function resolveScope(Request $request): HardwareWorkspaceScope
    {
    ...
    private function resolveFilter(Request $request, HardwareWorkspaceScope $scope): HardwareWorkspaceFilter
    {
        if ($scope === HardwareWorkspaceScope::Shipped) {
            return HardwareWorkspaceFilter::All;
        }
        ...
        return $filter ?? HardwareWorkspaceFilter::All;
    }
