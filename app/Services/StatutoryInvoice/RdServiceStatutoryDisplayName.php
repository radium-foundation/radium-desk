...
final class RdServiceStatutoryDisplayName
{
    ...
    public static function normalizeInvoiceDescription(string $description, ?Carbon $commercialAt = null): string
    {
        if ($commercialAt === null || ! StatutoryInvoiceScope::contains($commercialAt)) {
            return $description;
        }
