...
class Customer360Service
{
    ...
    public function drawerData(Incident $incident): array
    {
        ...
        if ($order === null) {
            return array_merge($this->emptyDrawerData($incident), [
                ...
                'canCorrectDeviceModel' => $actionVisibility['canCorrectDeviceModel'],
                'canCorrectDeviceIdentity' => $actionVisibility['canCorrectDeviceIdentity'],
                ...
                'correctDeviceModelEligibility' => $actionVisibility['correctDeviceModelEligibility'],
                'correctDeviceIdentityEligibility' => $actionVisibility['correctDeviceIdentityEligibility'],
    ...
    private function emptyDrawerData(Incident $incident): array
    {
        ...
        return [
            ...
            'correctDeviceModelEligibility' => [
                'allowed' => false,
                'reason' => 'This service case is not linked to an order.',
            ],
            'correctDeviceIdentityEligibility' => [
                'allowed' => false,
                'reason' => 'This service case is not linked to an order.',
            ],
