<x-settings-center.card title="SLA Thresholds" description="Configure warning and overdue thresholds for service cases." icon="gauge">
    <form method="POST" action="{{ route('settings.sla.update') }}" class="settings-center-form">
        @csrf
        @method('PUT')
        <div class="row g-3">
            <div class="col-md-6">
