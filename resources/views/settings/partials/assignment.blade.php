<x-settings-center.card title="Assignment" description="Shift routing, timezone, and fallback administrator configuration." icon="settings">
    <form method="POST" action="{{ route('settings.assignment.update') }}" class="settings-center-form">
        @csrf
        @method('PUT')
        <div class="row g-3">
            <div class="col-md-4">
