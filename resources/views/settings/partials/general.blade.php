<x-settings-center.card title="General" description="Company identity and regional defaults.">
    <form method="POST" action="{{ route('settings.general.update') }}" class="settings-center-form">
        @csrf
        @method('PUT')
        <div class="row g-3">
            <div class="col-md-6">
