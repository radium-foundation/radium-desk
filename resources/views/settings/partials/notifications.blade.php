<x-settings-center.card title="Notifications" description="Application-level notification preferences for operators." icon="bell">
    <form method="POST" action="{{ route('settings.notifications.update') }}" class="settings-center-form">
        @csrf
        @method('PUT')
        <p class="settings-center-helper">
