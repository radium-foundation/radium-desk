@if(session('status'))
    @php
        $toastMessage = match (session('status')) {
            ...
            'todo-category-created' => 'To-do category added successfully.',
            'todo-category-updated' => 'To-do category updated successfully.',
            'todo-category-activated' => 'To-do category activated successfully.',
            'todo-category-deactivated' => 'To-do category deactivated successfully.',
