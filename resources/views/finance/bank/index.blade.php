...
@section('content')
    <div class="mb-4">
        ...
        <p class="text-muted mb-0">Movements from the general ledger for linked bank accounts.</p>
    </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-5">
            <form method="GET" action="{{ route('finance.bank.index') }}">
                <label for="bank_account_id" class="form-label">Bank account</label>
                <select id="bank_account_id" name="bank_account_id" class="form-select" onchange="this.form.submit()">
