...
class TelegramChannelTest extends TestCase
{
    ...
    public function test_send_returns_not_yet_configured_success(): void
    {
        ...
        $result = app(TelegramChannel::class)->send($message);

        $this->assertTrue($result->success);
        $this->assertSame(NotificationChannelType::Telegram, $result->channel);
    ...
    private function makeMessage(): NotificationMessage
    {
        ...
        $incident = Incident::query()->create([
            ...
            'description' => 'Telegram channel test.',
