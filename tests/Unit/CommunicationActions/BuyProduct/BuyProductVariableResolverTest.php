...
class BuyProductVariableResolverTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_resolves_buy_product_variables_from_device_model_catalog(): void
    {
        ...
        $deviceModel = DeviceModel::query()->create([
            'name' => 'MFS 110',
            'buy_device_url' => 'https://ra8.in/buy-mfs110',
            'display_order' => 1,
            'is_active' => true,
        ]);

        $order = Order::query()->create([
            'order_id' => 'RD-BUY-PROD-VARS',
        ...
        $incident = Incident::query()->create([
            ...
            'title' => 'Buy Product variable case',
            'description' => 'Buy Product variable case.',
        ...
        $definition = app(CommunicationActionRegistry::class)->get(CommunicationActionKey::BuyProduct);
        ...
        $this->assertSame('https://ra8.in/buy-mfs110', $variables['buy_device_url']);
        ...
        $this->assertSame(['buy-mfs110'], $variables['whatsapp_button_values']);
    }
}
