...
class RdServiceStatutoryDisplayNameTest extends TestCase
{
    ...
    public function test_legacy_channel_description_is_normalized_without_sac_suffix(): void
    {
        ...
        $normalized = RdServiceStatutoryDisplayName::normalizeInvoiceDescription(
            $legacy,
    ...
    public function test_pre_september_commercial_date_preserves_legacy_description(): void
    {
        $legacy = 'Information technology (IT) consulting & support services (SAC - 998313) - 1 Year Unlimited';

        $this->assertSame(
            $legacy,
            RdServiceStatutoryDisplayName::normalizeInvoiceDescription(
                $legacy,
    ...
    public function test_missing_commercial_date_preserves_legacy_description(): void
    {
        $legacy = 'Information technology (IT) consulting & support services (SAC - 998313)';

        $this->assertSame($legacy, RdServiceStatutoryDisplayName::normalizeInvoiceDescription($legacy));
    }
