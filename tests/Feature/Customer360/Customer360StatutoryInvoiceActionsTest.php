...
class Customer360StatutoryInvoiceActionsTest extends TestCase
{
    ...
    public function test_customer_360_shows_failed_when_b2b_statutory_data_is_incomplete(): void
    {
        ...
        $this->actingAs($this->agent)
            ...
            ->assertSee('Statutory data required for e-Invoice is incomplete.', false)
            ->assertDontSee('IRN Generated', false);
    }
    ...
    public function test_customer_360_wallet_ledger_tab_remains_available_with_statutory_invoice_section(): void
    {
        $financeUser = User::factory()->create(['is_active' => true]);
        $financeUser->assignRole(RolePermissionSeeder::ROLE_OPERATIONS_ADMIN);

        [$incident, $invoice] = $this->issuedCase('RD-C360-INV-WALLET', 'wallet@example.com');
